...
/* WARNING: This code is used only for you to debug your own FCFS scheduler. You should NOT use this as a template for the remaining two schedulers. Otherwise, your codes may not pass plagiarism tests. */
