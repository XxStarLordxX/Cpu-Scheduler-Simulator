...
struct process {
    ...
    int isProcessing;		 /* if the process is in device queue or if the process is being processed by a CPU */
    int hasStarted;             /* Whether the process has started */
    int interrupted;				 /* Whether the process has just been interrupted. */
};
